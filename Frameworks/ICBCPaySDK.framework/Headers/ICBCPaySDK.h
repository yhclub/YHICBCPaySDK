...
// *  支付列表 用户选择支付结果回调
// *
// *  @param paymethod  支付方式@“epay”／@“wxpay”
// */
//- (NSDictionary*)epayOrWxpay:(NSString*)paymethod;
 ...
 *  支付列表接口 支付接口
 *
 *  @param viewController 推出支付列表界面的ViewController
...
@property (nonatomic, strong) NSString *urlPortal;//跳转h5地址，手机银行地址
